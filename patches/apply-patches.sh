...
patch -p1 -b < ../../../device/CUBOT/X18/patches/package_apps_settings/0001-android_settings_developer_info.patch
git clean -f -d
cd ../../..
cd frameworks/av
...
# patch -p1 < ../../device/CUBOT/X18/patches/frameworks_base/0005-frameworks_base_signature_spoofing.patch
# git clean -f -d
cd ../..
